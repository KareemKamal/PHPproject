...
$(function(){
	...
	$('.social').append('<span></span>').find('span').css({opacity:0}).parent().hover(function(){$(this).find('>span').stop().animate({opacity:1}).parent().find('>img').stop().animate({opacity:0})},function(){$(this).find('>span').stop().animate({opacity:0}).parent().find('>img').stop().animate({opacity:1})}).each(
		function(){
		var src=new Array()
	...
	$('.partner').hover(function(){$(this).find('img').stop().animate({opacity:.7})},(function(){$(this).find('img').stop().animate({opacity:1})}))
})			
